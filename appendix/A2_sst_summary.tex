...
This now lets us write the Average Model \TrainingError $\AVGSTTE$ in the AA in terms of the \AnnealedHamiltonian $\GANR$:
 ...
 \begin{align}
  ...
  &=  \dfrac{\partial }{\partial \beta} \left(-\cancel{\frac{1}{\ND}?}\ln \frac{1}{\ND} \int d\mu(\NDXIn)e^{-\beta\DETOPXI}\right) \\ \nonumber
  &=  -\frac{1}{\ND}\dfrac{\partial }{\partial \beta} \ln \frac{1}{\ND}\int d\mu(\NDXIn)e^{-\beta\DETOPXI} \\ \nonumber
