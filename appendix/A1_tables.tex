...
\hline
\textbf{Energy or \StudentTeacher (ST) Error} & $\DEL$, $\DELBF$ (simplified)& Sec.~\ref{sxn:SMOG_main},~\ref{sxn:summary_sst92} \\
\hthinline
The squared between the output of a \Student NN and its prescribed Teacher label $y_T$ for a single data point &$\DEL:=(y_T-\SOUT)^2 $ & \ref{eqn:DEy} \\
...
$\EPSL(R)=\tfrac{1}{\ND}\mathcal{E}(R)=\langle \DELBF\rangle_{\AVGNDXI}$ & ~\ref{eqn:e0}\\
