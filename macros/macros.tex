...
\newcommand{\TRACELOG}{\texttt{ERG}\xspace}
\newcommand{\ERG}{\texttt{ERG}\xspace}
...
\newcommand{\YsIS}[1]{\MY_{\mu=#1}^{S}}
\newcommand{\YtIS}[1]{\MY_{\mu=#1}^{T}}
...
\newcommand{\AVGNDXI}{\overset{\rule{0.6em}{0.7pt}}{\scriptscriptstyle\boldsymbol{\xi}^{n}}}
\newcommand{\AVGNDXIn}{\overset{\rule{0.6em}{0.7pt}}{\scriptscriptstyle\boldsymbol{\xi}^{\ND}}}
...
\newcommand{\NNOUT}{E^{out}_{NN}}
\newcommand{\TOUT}{E^{out}_{T}}
\newcommand{\SOUT}{E^{out}_{S}}
...
%\newcommand{\DEL}{\mathrm{E}}_{\mathcal{L}}}

\newcommand{\DELBF}{\mathbf{\mathrm{E}}^{n}_{\mathcal{L}}}
\newcommand{\DELBFell}{\mathbf{\mathrm{E}}^{n}_{\mathcal{\ell}}}
\newcommand{\DET}{\mathrm{E}_{\mathcal{L}}(\mathbf{w},\XI)}
\newcommand{\DETmu}{{E}_{\mathcal{L}}(\mathbf{w},\XI_{\mu})}

\newcommand{\DETeff}{\mathrm{E}^{eff}_{\mathcal{L}}(\mathbf{w},\XI)}
\newcommand{\DETST}{\mathrm{E}^_{\mathcal{L}}(\SVEC,\TVEC,\XI)}
\newcommand{\DETSTL}{\mathrm{E}_{\mathcal{L}}(\SVEC,\TVEC,\XI)}
\newcommand{\DETOPSTL}{{\mathrm{E}}^{n}_{\mathcal{L}}(\SVEC,\TVEC,\NDXI)}
\newcommand{\DETOPSTx}{{\mathrm{E}}^{n}_{\mathcal{L}}(S,T,\DX)}
\newcommand{\DETSTLL}{{E}_{\ell_2}(\SVEC,\TVEC,\XI)}
\newcommand{\DETOP}{{\mathrm{E}}^{n}_{\mathcal{L}}(\mathbf{w})}
\newcommand{\DETOPX}{{\mathrm{E}}^{n}_{\mathcal{L}}(\mathbf{w}, \NDX)}
%\newcommand{\DETOPXY}{\mathbf{\mathrm{E}}^{n}_{\mathcal{L}}(\mathbf{w}, \NDX, \MY^{n})}

\newcommand{\DETOPXY}{\mathrm{{E}}^{n}_{\mathcal{L}}(\mathbf{w}, \NDX, \MY^{n})}
\newcommand{\DEL}{{E}_{\mathcal{L}}}
\newcommand{\DELell}{\mathrm{E}_{\ell_2}}

\usepackage{bm}

\newcommand{\DETOPXI}{\mathbf{\mathrm{E}}^{n}_{\mathcal{L}}(\mathbf{w}, \XI^{n})}
\newcommand{\DETOPXILL}{\mathbf{\mathrm{E}}^{n}_{\ell_2}(\mathbf{w}, \XI^{n})}
\newcommand{\DETOPSTLL}{\mathbf{\mathrm{E}}^{n}_{\ell_2}(\SVEC,\TVEC, \XI^{n})}
\newcommand{\DETOPST}{\mathbf{\mathrm{E}}^{n}_{\ell_2}(\SMAT,\TMAT)}
\newcommand{\DETOPNN}{\mathbf{\mathrm{E}}^{n}_{\ell_2}(\SMAT,\TMAT, \NDXI)}
\newcommand{\DETOPNNXI}{\mathbf{\mathrm{E}}^{n}_{\ell_2}(\SMAT,\TMAT|\XI^{n})}
...
\newcommand{\EVEC}{\mathbf{E}^{out}}


%\newcommand{\LambdaECSmin}{\lambda^{ECS}_{min}}
\newcommand{\LambdaECSmin}{{\LambdaECS_{min}}}
...
\newcommand{\ZAN}{Z^{an}_{\ND}}
\newcommand{\ZHT}{Z^{hT}_{\ND}}
\newcommand{\ZANHT}{Z^{an,hT}_{\ND}}

% Hamiltonian
\newcommand{\HH}{\mathbf{H}}

% Replica averages 
\newcommand{\REPLICA}{[\mathbf{\XI}^{\ND}]_{r}}
\newcommand{\DEREPLICA}{\mathcal{E}(\mathbf{w}|[\mathbf{\XI}^{\ND}]_{r})}
...
\newcommand{\IMm}{\mathbf{I}_m} % identity operator
...
\newcommand{\ETAMAT}{\eta(\SMAT_l,\TMAT_l,\NDXI)\xspace}
\newcommand{\ETAMATAVG}{\langle\eta(\SMAT_l,\TMAT_l,\NDXI)\rangle_{\AVGNDXI}\xspace}
\newcommand{\AVGR}{R\xspace}
\newcommand{\LargeN}{Large-$\mathcal{N}\;$\xspace}
%\newcommand{\NWICK}{\mathcal{N}_{Wick}}
\newcommand{\NWICK}{\mathcal{N}_{\!\scalebox{0.6}{\textit{Wick}}}}