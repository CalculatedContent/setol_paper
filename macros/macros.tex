...
\newcommand{\DELBF}{\mathbf{\Delta E}^{\red{2}}_{\mathcal{L}}}
...
\newcommand{\DETOPSTL}{\mathbf{\Delta {E}}^{\red{2}}_{\mathcal{L}}(\SVEC,\TVEC,\NDXI)}
...
\newcommand{\DETOPNN}{\mathbf{\Delta {E}}^{\red{2}}_{\ell_2}(\SMAT,\TMAT, \NDXI)}
