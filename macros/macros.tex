...
\newcommand{\DETmu}{\mathrm{E}_{\mathcal{L}}(\mathbf{w},\XI_{\mu})}
...
\newcommand{\DETOPSTL}{\mathbf{\mathrm{E}}^{n}_{\mathcal{L}}(\SVEC,\TVEC,\NDXI)}
\newcommand{\DETOPSTx}{\mathbf{\mathrm{E}}^{n}_{\mathcal{L}}(S,T,\DX)}
\newcommand{\DETSTLL}{\mathrm{E}_{\ell_2}(\SVEC,\TVEC,\XI)}
\newcommand{\DETOP}{\mathbf{\mathrm{E}}^{n}_{\mathcal{L}}(\mathbf{w})}
\newcommand{\DETOPX}{\mathbf{\mathrm{E}}^{n}_{\mathcal{L}}(\mathbf{w}, \NDX)}
%\newcommand{\DETOPXY}{\mathbf{\mathrm{E}}^{n}_{\mathcal{L}}(\mathbf{w}, \NDX, \MY^{n})}

\newcommand{\DETOPXY}{\mathbf{{E}}^{n}_{\mathcal{L}}(\mathbf{w}, \NDX, \MY^{n})}
\newcommand{\DEL}{\mathrm{E}_{\mathcal{L}}}
