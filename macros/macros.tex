...
\newcommand{\AVGNDXI}{{\small \overset{\rule{0.6em}{0.7pt}}{\boldsymbol{\xi}^{N}}}}
\newcommand{\AVGNDXIn}{{\small \overset{\rule{0.6em}{0.7pt}}{\boldsymbol{\xi}^{n}}}}
...
\newcommand{\DETmu}{\Delta E_{\mathcal{L}}(\mathbf{w},\XI_{\mu})}
...
\newcommand{\AECSM}{\tilde{\mathbf{A}}_{\small{M}}}
\newcommand{\AECSN}{\tilde{\mathbf{A}}_{\small{N}}}
\newcommand{\AMATM}{{\mathbf{A}}_{\small{M}}}
\newcommand{\AMATN}{{\mathbf{A}}_{\small{N}}}
...
\newcommand{\EZDAONE}{\mathbb{E}_{\AMATM}[\ZIZ]}
\newcommand{\EZDATWO}{\mathbb{E}_{\AMATN}[\ZIZ]}

\newcommand{\EQN}{Eqn.}
\newcommand{\Det}[1]{\mbox{}{\text{det}}\left(#1\right)}
%\newcommand{\DeltaMu}{\delta_{\mu}}
\newcommand{\DeltaMu}{\vartheta_{\mu}}
\newcommand{\IM}{\mathbf{I}_{\small{M}}} % identity operator
\newcommand{\IH}{\mathbb{I}_{\small{H}}} % integral
...
\newcommand{\ETAMLPAVG}{\langle\eta([\SMAT_l,\TMAT_l],\XI)\rangle_{\AVGNDXI}\xspace}
