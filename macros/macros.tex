...
\newcommand{\DETOPXI}{\mathbf{\Delta {E}}_{\mathcal{L}}(\mathbf{w}, \XI)}
\newcommand{\DETOPXILL}{\mathbf{\Delta {E}}_{\ell_2}(\mathbf{w}, \XI)}
\newcommand{\DETOPSTLL}{\mathbf{\Delta {E}}_{\ell_2}(\SVEC,\TVEC, \XI)}
\newcommand{\DETOPST}{\mathbf{\Delta {E}}_{\ell_2}(\SMAT,\TMAT)}
\newcommand{\DETOPNN}{\mathbf{\Delta {E}}_{\ell_2}(\SMAT,\TMAT, \XI)}
\newcommand{\DETOPNNXI}{\mathbf{\Delta {E}}_{\ell_2}(\SMAT,\TMAT|\XI)}
