...
The Total Model Error of Energy Difference, $\DELBF$, represents the difference (squared) between the model and its labels for the ST model between
...
for the \SETOL, this is  the ($M$-dimensional) identity minus the overlap operator/matrix, $N(\IM-\OVERLAP)$. 
