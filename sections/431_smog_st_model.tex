...
%\red{[NOTE: This is describing OUR ST model, not the classical one. We will need to resolve this.]\\}
% Kets just say that
We start by describing how to obtain a simple formal expression for the empirical test errors of the \Teacher, first for the \TrueAccuracy. \red{[And then? Generalization accuracy?]}

\cyan{EXPLAIN HERE how the Teacher is the input}
