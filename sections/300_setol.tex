...
In deriving these quantities, we will introduce to NN theory a new \SemiEmpirical approach that combines techniques from \STATMECH and \RMT in a novel way. \red{It is \SemiEmpirical because we derive from first principles the fact that model quality must depend on the spectrum density of the weight matrix, but in practice, we must empirically determine the density's parametric functional form in order to derive an expression of model quality.}
