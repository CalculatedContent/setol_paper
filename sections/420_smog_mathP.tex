...
this notation denotes an inner product in a Hilbert space of functions;
...
This distinction will be clarified in the Section~\ref{sxn:SMOG_main-student_teacher}.}
...
In Appendix~\ref{sxn:summary_sst92} we show how to obtain 
