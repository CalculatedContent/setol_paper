...
Consider a large set $\ND$ of actual, real-world data, 
\begin{align}
  \label{eqn:x}
...
\end{align}
These equations guarantee that the solution $\EPSL(\WVEC^{*})$ is at a (local) minimum in $\WVEC$.
