...
as a difference in energy $\Delta E^{\red{2}}_{\mathcal{L}}$ between the student's and teacher's output, since their outputs are a form of energy.
\footnote{although technically $\Delta E^{\red{2}}_{\mathcal{L}}$ is a difference squared,  the NN output function $E_{NN}$ is not an energy in the sense here, whereas $\Delta E^{\red{2}}_{\mathcal{L}}$ will have units of Energy for purposes of the discussion on this section.} 
Smaller energy differences correspond to smaller errors and therefore better models.
