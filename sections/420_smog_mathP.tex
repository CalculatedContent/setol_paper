...
where $n$ is the number of free parameters ($n=N$ for a vector model, but a matrix model has $N\timex M$ free parameters; see Appendix~\ref{app:st-gen-err-annealed-ham}).
