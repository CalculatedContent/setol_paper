...
\begin{align}
  \label{eqn:Emap}
  \frac{1}{n}\DETOPX \xrightarrow{\text{expected value}} \frac{1}{n}\langle \DETOPXI \rangle_{\NDXIn} %= \DETOT = n \EPSLw.
\end{align}
...
We need to compute various integrals,  averages, and \emph{\ExpectedValues}, 
...
We will denote Expected Values using physics \BraKet notion.  
 ...
 \footnote{The BraKet  notation denotes an inner product in a Hilbert space of functions.}
