...
\begin{figure}[t] %[h]
    ...
    \subfigure[MP, varying $Q=\tfrac{N}{M}$]{ 
      \includegraphics[width=4.0cm]{./img/mp-Q.png}
      \label{fig:MP-esds-a}
    }                               
    \subfigure[Tracy Widom fluctuations]{
      \includegraphics[width=4.0cm]{./img/mp-TW.png}
      \label{fig:MP-esds-b}
    }                    
...
\begin{figure}[h]
    ...
    \subfigure[Heavy Tailed ESDs]{ 
      \includegraphics[width=5cm]{./img//heavy-tailed-log-log-esds.png}
      \label{fig:HT-esds-a}
    }                               
    \subfigure[PL $\alpha$ vs HT $\mu$ exponent]{
      \includegraphics[width=5cm]{./img/alpha-mu-plot2.png}
      \label{fig:HT-esds-b}
    }                                                                                                                            
