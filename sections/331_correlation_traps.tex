...
anomalously large (because they may be a rank-1 perturbation consisting of more than one element\red{, corresponding to a shift in mass of the distribution of weights away from $0$}).  Here, we can apply elementary RMT, as in the \HTSR approach.
