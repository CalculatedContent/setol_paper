...
anomalously large but, insteading, looking for what can be multi-element rank-1 perturbations in $\WMAT$.  Here, we can apply elementary RMT, as in the \HTSR approach.
