...
% Dead Hoirse .  
%\red{\SETOL can do this where standard \SMOG cannot because \SETOL only assumes supervision in the form of ESDs, and not labels, allowing a finer characterization of defects in the supervision, rather than just ``label noise''.}
