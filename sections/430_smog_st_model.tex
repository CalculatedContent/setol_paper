...
In this subsection, we present a unified view of the \emph{\StudentTeacher} (ST) model from both a practical and a theoretical perspective.  
...
\michaelB{Maybe some of those two pars should be in Section~\ref{sxn:trad_smog}.}
