...
\red{Importantly, being empirical quantities, the weight matrices are implicitly normalized by $1/\ND$, and, like the ST vectors, also implicitly normalized by $1/M$. (See Appendix~\ref{app:appendix_Gan})}
