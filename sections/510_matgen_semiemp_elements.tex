...
which, as shown by Tanaka \cite{Tanaka2007, Tanaka2008}, is expressed in terms of the R-transform $R_{\AMATM}(z)$, defined for the tail of the limiting form of the ESD of $\AMATM$,  $\rho^{\infty}_{\AMATM}(\lambda$).
