...
\red{And, importantly, being empirical quantities, the weight matrices are implicitly normalized to $1/\ND$.}
...
the Exact Renormalization Group (\TRACELOG) Condition and the \IndependentFluctuationApproximation (\IFA).
