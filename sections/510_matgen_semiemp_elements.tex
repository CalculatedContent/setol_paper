...
$\AMAT_N = \tfrac{1}{N}\SMAT\SMAT^{\top}$ along with their Inner counterparts
$\AMAT_M = \tfrac{1}{N}\SMAT^{\top}\SMAT$.
Importantly, we argue that the measures $d\mu(\AMAT_M)\leftrightarrow d\mu(\AMAT_N)$,
