...
We can define \red{need to explain that the $\ND$ average is implicit in the matrices because they are measurables, and the $1/N$ is necessary for reasons we need to expand on and clarify}
\begin{equation}
