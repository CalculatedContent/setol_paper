...
should instead average over a low rank subspace spanned \emph{only by} the generalizing eigen-components of the Inner Correlation matrix, $\AMATM=\tfrac{1}{N}\SMAT^{\top}\SMAT$
