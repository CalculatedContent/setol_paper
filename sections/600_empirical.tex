...
%\item
%\textbf{\ModelQuality: \SETOL Generalized norms.}
%  \charles{We want to evaluate the different models for the \RTransform. This means
%  (1) compare the Tail Norm to the matrix cummulants.
%    (2) compute the alpha-hat metric with the correlation trap, and show that alpha-hat fixes this for FC1.
%  }
\item
