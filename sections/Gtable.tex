...
\begin{table}[h!]
  ...
  \begin{tabular}{|c|p{2.5cm}|c|c|} % Removed the last 'p{4.5cm}' column
    ...
    & ECS Boundary*
    & \ALPHAHAT $\;\;\hat{alpha}$
    & $\displaystyle \alpha\log\lambda_{\max} \;+\;\mathrm{const.}$ \\ \hline
  ...
  \caption{Closed-form or leading-order expressions for the log \LayerQuality
            ...
            \InverseMP (IMP): Also gives ~\ALPHAHAT, and, importably, a branch cut that defines the \ECS Boundary *(not a Tail norm).
             }
