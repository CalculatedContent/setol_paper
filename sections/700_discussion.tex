...
When training a Student NN $S$ to emulate a larger Teacher $T$, the Student inherits the inductive biases and generalization behavior of Teacher, which \SETOL explains is concentrated in smaller (i.e. lower rank) layer weight matrices of $T$.
...
\RenormalizationGroup analogy, understanding layer-layer interactions expansions, and systematically diagnosing correlation 
