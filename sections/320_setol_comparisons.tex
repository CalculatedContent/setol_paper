...
\end{enumerate}
In Section~\ref{sxn:empirical}, we will test and justify this conjecture by showing that the induced measures of each condition converge to one another at the same rate, and reach convergence at the exact point beyond which accuracy begins to degrade.
