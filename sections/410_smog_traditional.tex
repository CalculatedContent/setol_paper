...
\red{START} This formulation of the ST problem differs from the classic approach~\cite{SST92,engel2001statistical} in that
...
the structure of the empirical \Teacher weight matrix  $\TMAT=\WMAT$ provides $N\times M$ additional \red{degrees of freedom?},
