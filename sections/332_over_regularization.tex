...
Occasionally, but very infrequently, we do observe $\alpha<2$s, and in large, production quality models
...
and observe the formation of a Very Heavy Tailed ESD in the dominating layer weight matrix.
