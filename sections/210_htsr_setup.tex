...
\begin{figure}[t] %[h]
    ...
    \subfigure[Log-Log ESD]{ 
      \includegraphics[width=3.5cm]{./img/fig1-1a.png}
      \label{fig:log-log-esd}                                                                                                      
    }                               
    \subfigure[Lin-Lin ESD]{ 
      \includegraphics[width=3.5cm]{./img/fig1-1b.png}
      \label{fig:lin-lin-esd}                                                                                                      
    }                               
    \subfigure[Log-Lin ESD]{ 
      \includegraphics[width=3.5cm]{./img/fig1-1c.png}
      \label{fig:log-lin-esd}                                                                                                      
    }                               
    \subfigure[$\lambda_{min}$ vs KS distance]{
      \includegraphics[width=3.5cm]{./img/fig1-1d.png}
