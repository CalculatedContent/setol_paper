...
We make this distinction between actual $\ADD$ and idealized data $\MDD$ to emphasize that,
...
In traditional \STATMECH (e.g., \cite{SST92}), one is interested in how the \emph{Total 
