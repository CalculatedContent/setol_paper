...
\end{align}
Since the data vectors are \emph{implicitly normalized to $1/m$}, the overlap $\AVGR\in[0,1]$. 
That is, there are no \emph{no inversely-correlated} Students that predict more than half the Teacher labels incorrectly.  And, importantly, the number of free parameters becomes $1$.
