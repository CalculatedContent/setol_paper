...
\nred{Removed subsection title; the format here should be the same as sections 4 and 6.
  We use different formats for  all 3; we need to decide on a standard format
  and align the subsection titles}
