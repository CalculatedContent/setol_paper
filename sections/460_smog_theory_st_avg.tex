...
\EPSLSTx = \red{\tfrac{1}{N}}\langle\DETOPSTL\rangle_{\NDXI}:=\frac{1}{N}\int d\mu(\NDXI)\DETOPSTL
\end{align}
...
\nred{CHECK THIS}
\begin{align}
\red{\tfrac{1}{N}?} \langle\DETOPSTLL\rangle_{\NDXI}  
...
\begin{align}
\label{eqn:e0}
\EPSL(R)=\red{\tfrac{1}{N}}\langle\DETOPSTLL\rangle_{\NDXI} =  1 - R .
\end{align}
%%%
%%% CHM: what is this ?
%%\begin{align}
...
\THRMAVG{1-\langle\ETA(\SVEC,\TVEC,\XI)\rangle_{\XI^{\red{N}}}}=
