...
\end{equation}
\nred{The results is effectively expressed in the limit of fixed load $N/\ND$, giving a kind of mean-field theory over $N$ interacting feature vectors of length $M$.}
