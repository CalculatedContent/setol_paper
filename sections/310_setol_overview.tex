...
\begin{itemize}
  ...
  \IZGINF = \lim_{N\gg 1}\red{\tfrac{1}{N}}\ln\int d\mu(\AECS)\exp\left(\ND\beta\Trace{\TMAT^{\TR}\AECSN\TMAT}\right) %= \beta\sum_{i=1}^{\MECS}\GNECS
  \end{align}
...
Importantly, in analogy with the Wilson Exact Renormalizaton Group theory, 
